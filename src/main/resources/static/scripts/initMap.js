...
(function () {
    ...
    google.maps.Load = function (apiLoad) {
        ...
        apiLoad([0.009999999776482582, [null, [["https://khms0.googleapis.com/kh?v=708\u0026hl=bg\u0026", "https://khms1.googleapis.com/kh?v=708\u0026hl=bg\u0026"], null, null, null, 1, "708", ["https://khms0.google.com/kh?v=708\u0026hl=bg\u0026", "https://khms1.google.com/kh?v=708\u0026hl=bg\u0026"]], null, null, null, null, [["https://cbks0.googleapis.com/cbk?", "https://cbks1.googleapis.com/cbk?"]], [["https://khms0.googleapis.com/kh?v=102\u0026hl=bg\u0026", "https://khms1.googleapis.com/kh?v=102\u0026hl=bg\u0026"], null, null, null, null, "102", ["https://khms0.google.com/kh?v=102\u0026hl=bg\u0026", "https://khms1.google.com/kh?v=102\u0026hl=bg\u0026"]], [["https://mts0.googleapis.com/mapslt?hl=bg\u0026", "https://mts1.googleapis.com/mapslt?hl=bg\u0026"]], null, null, null, [["https://mts0.googleapis.com/mapslt?hl=bg\u0026", "https://mts1.googleapis.com/mapslt?hl=bg\u0026"]]], ["bg", "US", null, 0, null, null, "https://maps.gstatic.com/mapfiles/", "https://csi.gstatic.com", "https://maps.googleapis.com", "https://maps.googleapis.com", null, "https://maps.google.com", "https://gg.google.com", "https://maps.gstatic.com/maps-api-v3/api/images/", "https://www.google.com/maps", 0, "https://www.google.com"], ["https://maps.googleapis.com/maps-api-v3/api/js/27/5/intl/bg_ALL", "3.27.5"], [2774144652], 1, null, null, null, null, null, "initMap", null, null, 1, "https://khms.googleapis.com/mz?v=708\u0026", "AIzaSyC17xb5NE_b6D7qGo6WGA7VEUldwMCX1Ms", "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "https://mts.googleapis.com/maps/vt/icon", [["https://maps.googleapis.com/maps/vt"], ["https://maps.googleapis.com/maps/vt"], null, null, null, null, null, null, null, null, null, null, ["https://www.google.com/maps/vt"], "/maps/vt", 370000000, 370], 2, 500, [null, null, null, null, "https://www.google.com/maps/preview/log204", "", "https://static.panoramio.com.storage.googleapis.com/photos/", ["https://geo0.ggpht.com/cbk", "https://geo1.ggpht.com/cbk", "https://geo2.ggpht.com/cbk", "https://geo3.ggpht.com/cbk"], "https://maps.googleapis.com/maps/api/js/GeoPhotoService.GetMetadata", "https://maps.googleapis.com/maps/api/js/GeoPhotoService.SingleImageSearch", ["https://lh3.ggpht.com/", "https://lh4.ggpht.com/", "https://lh5.ggpht.com/", "https://lh6.ggpht.com/"]], ["https://www.google.com/maps/api/js/master?pb=!1m2!1u27!2s5!2sbg!3sUS!4s27/5/intl/bg_ALL", "https://www.google.com/maps/api/js/widget?pb=!1m2!1u27!2s5!2sbg"], null, 0, null, "/maps/api/js/ApplicationService.GetEntityDetails", 0, null, null, [null, null, null, null, null, null, null, null, null, [0, 0]], null, [], ["27.5"]], loadScriptTime);
    };
...
(function (_) {
    ...
    Ra = function (a, b) {
        for (var c = a.length, d = _.Aa(a) ? a.split("") : a, e = 0; e < c; e++)if (e in d && b.call(void 0, d[e], e, a))return e;
        return -1
    };
    _.Ta = function (a, b) {
        b = _.Qa(a, b);
    ...
    sc = function (a) {
        ...
        try {
            _.Hb({height: _.oc, width: _.oc}, !0)(a)
        } catch (b) {
    ...
    _.dd = function () {
        this.P = new Zc({gd: (0, _.p)(this.gd, this), jd: (0, _.p)(this.jd, this)})
    };
    _.ed = function () {
        _.dd.call(this)
    };
    ...
    Fd = function (a, b, c) {
        for (var d = 1; d < b.A.length; ++d) {
            ...
            if (e && null != f)if (3 == e.label)for (var g = 0; g < f.length; ++g)Ed(f[g], d, e, c); else Ed(f, d, e, c)
        }
    };
    Ed = function (a, b, c, d) {
        if ("m" == c.type) {
    ...
    _.Ie = function (a, b, c) {
        ...
        if (!b)return [];
        c = c || {};
        var l = _.Lb(_.oc), n = _.Lb(h), q = _.Lb(g), r = _.Lb(function (a) {
            a = n(a);
    ...
    uf = function (a, b, c, d) {
        ...
        this.j = new sf(c, {visible: !1, enableCloseButton: !0, ea: e});
    ...
    _.$f = function (a, b) {
        b = b || {};
        var c = b.fn || {}, d = _.Ad(_.R, 12).join(",");
        d && (c.libraries = d);
        var d = _.P(_.R, 6), e = new df(_.R.data[33]), f = [];
        d && f.push(d);
    ...
    Mg = function () {
        var a = _.O(new kf(_.R.data[4]), 0), b = new Ig(131071), c = (0, window.unescape)("%26%74%6F%6B%65%6E%3D");
        return function (d) {
            d = d.replace(Kg, "%27");
            var e = d + c;
            Lg || (Lg = /(?:https?:\/\/[^/]+)?(.*)/);
    ...
    _.k.set = function (a, b) {
        ...
        a += "";
        var d = ib(c, a);
        if (d)if (a = d.ab, d = d.Bc, c = "set" + _.Cb(a), d[c]) d[c](b); else d.set(a, b); else this[a] = b, c[a] = null, Ab(this, a)
    };
    ...
    _.A.prototype.bindTo = function (a, b, c, d) {
        ...
        c = (c || a) + "";
        this.unbind(a);
        var e = {Bc: this, ab: a}, f = {Bc: b, ab: c, yg: e};
        Db(this)[a] = f;
        zb(b, c)[_.xb(e)] = e;
        d || Ab(this, a)
    };
    ...
    _.Wg = {ROADMAP: "roadmap", SATELLITE: "satellite", HYBRID: "hybrid", TERRAIN: "terrain"};
    _.rf = {
        TOP_LEFT: 1,
        TOP_CENTER: 2,
        TOP: 2,
    ...
    var Xg = {To: "Point", Ro: "LineString", POLYGON: "Polygon"};
    _.t(Eb, Error);
    var Yg, $g;
    ...
    _.bh = _.Pb(_.Zg);
    _.ch = _.Pb($g);
    var Ub = _.Hb({lat: _.oc, lng: _.oc}, !0);
    ...
    var gh = _.Hb({zoom: _.Pb(Yg), heading: Yg, pitch: Yg});
    _.t(_.Fc, _.A);
    var hh = function (a) {
        return function () {
            return a
    ...
    Od.prototype.set = function (a, b) {
        if (null != b && !(b && _.x(b.maxZoom) && b.tileSize && b.tileSize.width && b.tileSize.height && b.getTile && b.getTile.apply))throw Error("\u041e\u0447\u0430\u043a\u0432\u0430\u043d\u0430 \u0441\u0442\u043e\u0439\u043d\u043e\u0441\u0442 \u043f\u0440\u0438 \u0432\u043d\u0435\u0434\u0440\u044f\u0432\u0430\u043d\u0435\u0442\u043e \u043d\u0430 google.maps.MapType");
    ...
    var ce = _.Hb({south: _.oc, west: _.oc, north: _.oc, east: _.oc}, !1);
    _.t(_.ee, _.A);
    _.k = fe.prototype;
    _.k.contains = function (a) {
    ...
    var ci = _.Hb({source: _.Zg, webUrl: _.bh, iosDeepLinkId: _.bh});
    var di = _.Ob(_.Hb({placeId: _.bh, query: _.bh, location: _.Zb}), function (a) {
    ...
    _.vc(ve.prototype, {
        ...
        label: _.Pb(_.Nb([_.Zg, {
            Yf: Rb("text"),
            then: _.Hb({text: _.Zg, fontSize: _.bh, fontWeight: _.bh, fontFamily: _.bh}, !0)
        }])),
        shadow: _.Gc,
        shape: _.Gc,
        cursor: _.bh,
    ...
    var ei = _.Mc.google.maps, fi = gc.zb(), gi = (0, _.p)(fi.cb, fi);
    ei.__gjsload__ = gi;
    _.Va(ei.modules, gi);
    delete ei.modules;
    ...
    _.ye.MAX_ZINDEX = 1E6;
    _.vc(_.ye.prototype, {map: _.Nb([_.hi, ii])});
    ...
    _.vc(Fe.prototype, {draggable: _.ch, editable: _.ch, map: _.hi, visible: _.ch});
    _.t(_.Ge, Fe);
    _.Ge.prototype.Da = !0;
    ...
    var oi = _.Hb({routes: _.Lb(_.Mb(_.db))}, !0);
    _.t(Ne, _.A);
    _.k = Ne.prototype;
    ...
    _.k.internalAnchorPoint_changed = Ne.prototype.internalPixelOffset_changed = function () {
        var a = this.get("internalAnchorPoint") || _.dh, b = this.get("internalPixelOffset") || _.eh;
    ...
    _.vc(Se.prototype, {directions: oi, map: _.hi, panel: _.Pb(_.Mb(Ib)), routeIndex: _.ah});
    ...
    _.vc(_.Ze.prototype, {map: _.hi, url: null, bounds: null, opacity: _.ah});
    _.ri = {
        UNKNOWN: "UNKNOWN",
        OK: _.ha,
    ...
    _.t(_.af, _.A);
    _.vc(_.af.prototype, {map: _.hi});
    _.t(bf, _.A);
    _.vc(bf.prototype, {map: _.hi});
    _.t(cf, _.A);
    _.vc(cf.prototype, {map: _.hi});
    ...
    _.t(Jf, _.Bf);
    var Kf = {roadmap: 0, satellite: 2, hybrid: 3, terrain: 4}, Pi = {0: 1, 2: 2, 3: 2, 4: 2};
    _.k = Jf.prototype;
    _.k.Yg = _.tc("center");
    _.k.lg = _.tc("zoom");
    _.k.changed = function () {
        var a = this.Yg(), b = this.lg(), c = Lf(this);
        if (a && !a.b(this.G) || this.F != b || this.O != c) Mf(this.f), this.K(), this.F = b, this.O = c;
        this.G = a
    };
    _.k.X = function () {
        var a = "", b = this.Yg(), c = this.lg(), d = Lf(this), e = this.get("size");
        if (e) {
            if (b && (0, window.isFinite)(b.lat()) && (0, window.isFinite)(b.lng()) && 1 < c && null != d && e && e.width && e.height && this.b) {
                ...
                if (f) {
                    ...
                    if (!Oi) {
                        ...
                        b = _.K(b, Ci);
                        f = new Hf([]);
                        Ni || (Ni = {b: -1, A: []}, Ni.A = [, _.rh, _.rh, _.yd(1)]);
                        f = _.K(f, Ni);
                        g = new Ff([]);
                        if (!Bi) {
                            var h = [];
                        ...
                        h = new df([]);
                        if (!ui) {
                            var l = ui = {b: -1, A: []}, n = new ef([]);
                            vi || (vi = {b: -1, A: [, _.T]});
                            var n = _.K(n, vi), q = new gf([]);
                            xi || (xi = {b: -1, A: [, _.T, _.T]});
                            var q = _.K(q, xi), r = new ff([]);
                            wi || (wi = {b: -1, A: [, _.T]});
                            l.A = [, n, , , , , , , , , q, , _.K(r, wi)]
                        }
    ...
    var cg;
    _.qg = "StopIteration" in _.Mc ? _.Mc.StopIteration : {message: "StopIteration", stack: ""};
    ...
    _.vc(wg.prototype, {map: _.hi, tableId: _.ah, query: _.Pb(_.Nb([_.Zg, _.Mb(_.db, "not an Object")]))});
    _.t(_.xg, _.A);
    ...
    _.vc(_.xg.prototype, {panes: null, projection: null, map: _.Nb([_.hi, ii])});
    _.t(_.yg, _.A);
    ...
    _.vc(_.yg.prototype, {center: _.Pb(_.Zb), draggable: _.ch, editable: _.ch, map: _.hi, radius: _.ah, visible: _.ch});
    _.t(_.zg, _.A);
    ...
    _.vc(_.zg.prototype, {draggable: _.ch, editable: _.ch, bounds: _.Pb(_.de), map: _.hi, visible: _.ch});
    _.t(Ag, _.A);
    ...
    _.k.pd = !0;
    _.vc(_.Cg.prototype, {opacity: _.ah});
    _.t(_.Fg, _.A);
    ...
    _.t(_.Gg, _.Fg);
    _.t(_.Hg, _.A);
    _.vc(_.Hg.prototype, {attribution: _.Pb(ci), place: _.Pb(di)});
    var Ri = {
        ...
        NavigationControlStyle: {
            DEFAULT: 0, SMALL: 1,
            ANDROID: 2, ZOOM_PAN: 3, Vo: 4, Yj: 5
        },
        OverlayView: _.xg,
        Point: _.H,
        Polygon: _.Ge,
